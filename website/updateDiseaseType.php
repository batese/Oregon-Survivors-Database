...
<html lang="en">
	<head>
		...
		<title>Search for Disease Types</title>
	...
	<body>
		...
		<div class="container">
			<h1>Search for Disease Types</h1>
			<p>You must first search for a disease type to update. Disease types cannot be removed from the database due to restrictions.</p>
			<form action="updateDiseaseTypeResult1.php" method ="GET" role="form" >
				<fieldset>
					<legend>Select a disease type</legend>
					<div class="row">
