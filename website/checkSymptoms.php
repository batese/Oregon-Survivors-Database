...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<h1>Welcome to the Oregon Survivors Database</h1>
        	<div id="symptoms">
				<form action="checkSymptomResults.php" method ="GET">
					<fieldset>
						...
						<table class="table table-bordered">
							...
							<?php
								...
								if(!($stmt = $mysqli->prepare("SELECT id, name, description FROM osdb_symptoms ORDER BY name ASC"))){
								...
								// Gets the results
								while($stmt->fetch()){
									echo "<tr><td><input type=\"checkbox\" name=\"symptoms[]\" value=\"" . $id . "\"></td><td>" . $name . "</td><td>" . $description . "</td></tr>";
								}
						...
						<input type="submit" id="submitSearch" value="Check Symptoms">
					</fieldset>
				</form>
			</div>
		</div><!-- /.container -->
