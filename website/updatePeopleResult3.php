...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<form action="updatePeopleResult4.php" method ="POST" role="form">
				<fieldset>
					<legend>Update Options</legend>
					<div class="col-md-4">
						<label for="firstName">First Name:</label>
						<input class="form-control" name="firstName" id="firstName" type="text" <?php echo "value=\"" . $_POST['fname'] . "\""; ?>>
					</div>
						<div class="col-md-4">
						<label for="middleName">Middle Name:</label>
						<input class="form-control" name="middleName" id="middleName" type="text" <?php echo "value=\"" . $_POST['mname'] . "\""; ?>>
					</div>
						<div class="col-md-4">
						<label for="surname">Surname:</label>
						<input class="form-control" name="surname" id="surname" type="text" <?php echo "value=\"" . $_POST['lname'] . "\""; ?>>
					</div>
					<div class="form-group">
						...
						<select class="form-control" name = "location" id="selectLocation">
							<?php 
								...
								if(!($stmt = $mysqli->prepare("SELECT id, name FROM osdb_settlements WHERE id = ?"))){
									echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
								}
								if(!($stmt->bind_param("i", $_POST['homeId']))){
					...
					<div class="form-group">
						<label for="dobafter">DOB:</label>	
						<input class="form-control" id="dob" name="dob" min="1945-01-01" max="2035-01-01" type="date"  <?php echo "value=\"" . $_POST['dob'] . "\""; ?>>
					</div>
					...
					<div class="form-group">
						<label for="socsec">Social Security Number:</label>
						<input class="form-control" name="socsec" id="socsec" type="text" <?php echo "value=\"" . $_POST['socsec'] . "\""; ?>>
					</div>
