...
<html lang="en">
	<head>
		...
		<title>Search for Symptoms</title>
	...
	<body>
		...
		<div class="container">
			...
			<p>You must first search for a symptom to update/remove.</p>
			<form action="updateSymptomResult1.php" method ="GET" role="form" >
				<fieldset>
					<legend>Select a symptom</legend>
					<div class="row">
						<div class="form-group">
							...
							<select class="form-control" name = "symptom" id="symptom">
								...
								<?php 
									...
									if(!($stmt = $mysqli->prepare("SELECT id, name FROM osdb_symptoms ORDER BY name ASC"))){
