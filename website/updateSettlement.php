...
<html lang="en">
	<head>
		...
		<title>Search for Settlements</title>
	...
	<body>
		...
		<div class="container">
			<h1>Search for Settlements</h1>
			<p>You must first search for a settlement to update. Settlements cannot be removed from the database due to restrictions.</p>
			<form action="updateSettlementResult1.php" method ="GET" role="form" >
				<fieldset>
					<legend>Select a Settlement</legend>
					<div class="row">
						<div class="form-group">
							<label for="settlement">Settlement:</label>					
							<select class="form-control" name = "settlement" id="selectSettlement">
