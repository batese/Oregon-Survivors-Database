...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<h1>Add Settlement to the Database</h1>
			<form action="addSettlementResult.php" method ="POST" role="form">
				<fieldset>
					...
					<div class="form-group">
						...
						<input type="number" min="-180" max="180" class="form-control" name="longitude" id="longitude">
					</div>
					<div class="form-group">
						<label for="name">Latitude:</label>
						<input type="number" min="-90" max="90" class="form-control" name="latitude" id="latitude">
					</div>
