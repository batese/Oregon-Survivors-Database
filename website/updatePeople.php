...
<html lang="en">
	<head>
		...
		<title>Update/Remove People</title>
	...
	<body>
		...
		<div class="container">
			<h1>Update/Remove People</h1>
			<p>Use this form to find a person to update/remove.</p>
			<form action="updatePeopleResult1.php" method ="GET" role="form">
				<fieldset>
					...
					<div class="col-md-6">
						<label for="dobafter">DOB after:</label>	
						<input class="form-control" id="dobafter" name="dobafter" min="1945-01-01" max="2035-01-01" type="date" value="1945-01-01">
					</div>
					<div class="col-md-6">
						<label for="dobbefore">DOB before:</label>	
						<input class="form-control" id="dobbefore" name="dobbefore" min="1945-01-01" max="2035-01-01" type="date" value="2035-01-01">
					</div>
