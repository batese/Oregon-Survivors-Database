...
<html lang="en">
	<head>
		...
		<title>Remove Clinic Result</title>
	...
	<body>
		...
		<div class="container">
			<h1>Remove Clinic Result</h1>
				<?php
					include 'databaseConnect.php';
					if(!($stmt = $mysqli->prepare("DELETE FROM osdb_clinics WHERE id = ?"))){
					...
					if(!$stmt->execute()){
						...
						echo "Removed " . $stmt->affected_rows . " rows from osdb_clinics.<br>";
					}
				?>
			</table>
		</div><!-- /.container -->
