...
<html lang="en">
	<head>
		...
		<title>Remove Person Result Result</title>
	...
	<body>
		...
		<div class="container">
			<h1>Remove Person Result</h1>
				<?php
					include 'databaseConnect.php';
					if(!($stmt = $mysqli->prepare("DELETE FROM osdb_people WHERE id = ?"))){
					...
					if(!$stmt->execute()){
						...
						echo "Removed " . $stmt->affected_rows . " rows from osdb_people.<br>";
					}
				?>
			</table>
		</div><!-- /.container -->
